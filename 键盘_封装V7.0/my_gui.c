...
void my_gui(void)
{
    ...
    my_str_kb_t my_str_kb = {0};
    keyboard = my_kb_init(act,&my_str_kb);
    lv_obj_add_event_cb(keyboard,event_cb,LV_EVENT_VALUE_CHANGED,NULL);

    my_str_ta_t my_str_ta = {0};
    my_str_ta.width = scr_act_width() -10;
    my_str_ta.height = scr_act_height()/2 -10;
    my_str_ta.position = LV_ALIGN_TOP_MID;
    ta = my_ta_init(act,act,&my_str_ta);
